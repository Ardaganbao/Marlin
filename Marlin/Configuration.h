...
#define STRING_CONFIG_H_AUTHOR "ARDAGAN" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ArdaPrint"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "860ddca7-1b9e-4bed-8581-419f843024e0"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.57,  20.0 }
    #define DEFAULT_Ki_LIST {   1.72,   1.0 }
    #define DEFAULT_Kd_LIST { 73.96, 112.0 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 106, 106 }
